...
/* First created by JCasGen Fri Mar 28 00:42:27 CST 2014 */
...
/** 
 * Updated by JCasGen Fri Mar 28 00:42:27 CST 2014
 * @generated */
public class ConfigAnnotation_Type extends Annotation_Type {
 ...
 // @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
 // @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.ConfigAnnotation");
  ...
  public String getExperimentId(int addr) {
      ...
      jcas.throwFeatMissing("experimentId", "edu.cmu.deiis.types.ConfigAnnotation");
  ...
  public int getOrigin(int addr) {
      ...
      jcas.throwFeatMissing("origin", "edu.cmu.deiis.types.ConfigAnnotation");
  ...
  public int getTarget(int addr) {
      ...
      jcas.throwFeatMissing("target", "edu.cmu.deiis.types.ConfigAnnotation");
  ...
  public ConfigAnnotation_Type(JCas jcas, Type casType) {
    ...
    casFeat_origin = jcas.getRequiredFeatureDE(casType, "origin", "edu.cmu.deiis.types.PathType", featOkTst);
    casFeatCode_origin  = (null == casFeat_origin) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_origin).getCode();

 
    casFeat_target = jcas.getRequiredFeatureDE(casType, "target", "edu.cmu.deiis.types.PathType", featOkTst);
