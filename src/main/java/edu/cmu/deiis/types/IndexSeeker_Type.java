...
public class IndexSeeker_Type extends ConfigAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  //@SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.IndexSeeker");
  ...
  public String getSortType(int addr) {
      ...
      jcas.throwFeatMissing("sortType", "edu.cmu.deiis.types.IndexSeeker");
