...
//  @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
//  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.PathType");
  ...
  public String getLocation(int addr) {
      ...
      jcas.throwFeatMissing("location", "edu.cmu.deiis.types.PathType");
  ...
  public boolean getIsFile(int addr) {
      ...
      jcas.throwFeatMissing("isFile", "edu.cmu.deiis.types.PathType");
