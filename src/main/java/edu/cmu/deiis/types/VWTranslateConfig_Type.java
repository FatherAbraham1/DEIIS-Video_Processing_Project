...
//  @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
 // @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.VWTranslateConfig");
  ...
  public String getClassifierMethod(int addr) {
      ...
      jcas.throwFeatMissing("classifierMethod", "edu.cmu.deiis.types.VWTranslateConfig");
  ...
  public int getDictionary(int addr) {
      ...
      jcas.throwFeatMissing("dictionary", "edu.cmu.deiis.types.VWTranslateConfig");
