...
/* First created by JCasGen Fri Mar 21 03:10:38 CST 2014 */
...
public class Annotation extends org.apache.uima.jcas.tcas.Annotation {
  ...
  */  
  ...
  /** getter for casProcessorId - gets Identifier for each CAS.
   * @generated
  ...
  /** setter for casProcessorId - sets Identifier for each CAS. 
   * @generated
  ...
  /** getter for confidence - gets Confidence level in each CAS.
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for confidence - sets Confidence level in each CAS. 
   * @generated
   * @param v value to set into the feature 
   */
