...
public class IndexGenConfig_Type extends ConfigAnnotation_Type {
 ...
 // @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
  //@SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.IndexGenConfig");
  ...
  public String getIndexMethod(int addr) {
      ...
      jcas.throwFeatMissing("indexMethod", "edu.cmu.deiis.types.IndexGenConfig");
