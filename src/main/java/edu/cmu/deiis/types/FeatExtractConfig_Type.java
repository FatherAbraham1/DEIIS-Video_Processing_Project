...
public class FeatExtractConfig_Type extends ConfigAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  //@SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.FeatExtractConfig");
  ...
  public String getImgExt(int addr) {
      ...
      jcas.throwFeatMissing("imgExt", "edu.cmu.deiis.types.FeatExtractConfig");
  ...
  public String getFeatMethod(int addr) {
      ...
      jcas.throwFeatMissing("featMethod", "edu.cmu.deiis.types.FeatExtractConfig");
