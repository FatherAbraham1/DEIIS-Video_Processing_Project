...
public class DictGenConfig_Type extends ConfigAnnotation_Type {
 ...
 // @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
 // @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.DictGenConfig");
  ...
  public String getClusterMethod(int addr) {
      ...
      jcas.throwFeatMissing("clusterMethod", "edu.cmu.deiis.types.DictGenConfig");
  ...
  public int getDictionarySize(int addr) {
      ...
      jcas.throwFeatMissing("dictionarySize", "edu.cmu.deiis.types.DictGenConfig");
