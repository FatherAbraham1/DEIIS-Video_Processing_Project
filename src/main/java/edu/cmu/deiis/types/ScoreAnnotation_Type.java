...
public class ScoreAnnotation_Type extends ConfigAnnotation_Type {
 ...
 // @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
  //@SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.ScoreAnnotation");
  ...
  public String getScoreMetric(int addr) {
      ...
      jcas.throwFeatMissing("scoreMetric", "edu.cmu.deiis.types.ScoreAnnotation");
