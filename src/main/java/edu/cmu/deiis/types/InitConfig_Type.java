...
//  @SuppressWarnings ("hiding")
  ...
  /** @generated 
     @modifiable */
  //@SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.InitConfig");
  ...
  public String getExperimentID(int addr) {
      ...
      jcas.throwFeatMissing("experimentID", "edu.cmu.deiis.types.InitConfig");
